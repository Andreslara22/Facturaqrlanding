...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .b-blog{background:#EDE9FE;color:#6D28D9}
...
(function(){
  ...
  var BLOGS = [
    {img:"blog-01-ticket-con-foto",       titulo:"Cómo facturar un ticket con una foto en 1 minuto"},
    {img:"blog-02-restaurantes-sin-fila",  titulo:"Facturación para restaurantes: adiós fila en caja"},
    {img:"blog-03-gasolineras-qr",         titulo:"Facturación para gasolineras con QR en la bomba"},
    {img:"blog-04-cfdi-40",                titulo:"Qué es el CFDI 4.0 explicado fácil (sin líos)"},
    {img:"blog-05-auto-vs-a-mano",         titulo:"Autofacturación vs facturar a mano: ¿qué conviene?"},
    {img:"blog-06-cuanto-cuesta",          titulo:"Cuánto cuesta un portal de autofacturación (2026)"},
    {img:"blog-07-csd-certifica",          titulo:"Qué es el CSD y cómo sacarlo con Certifica del SAT"},
    {img:"blog-08-cafeterias",             titulo:"Autofacturación para cafeterías, panaderías y food trucks"}
  ];
  ...
  function tarjetaBlog(b){
    ...
    return '<div class="card">' +
      ...
      '<div class="card-body">' +
        '<div class="badges"><span class="badge b-blog">blog</span></div>' +
        '<p class="tema">' + esc(b.titulo) + '</p>' +
      '</div></div>';
  }
  ...
  var html = '';
  html += '<p class="grupo-title">Imágenes para los blogs (redes)</p><div class="grid">' + BLOGS.map(tarjetaBlog).join('') + '</div>';
