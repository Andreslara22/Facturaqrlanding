...
(function(){
  ...
  var BASE = 'CONTEXTO DEL PRODUCTO (fuente de verdad, extraído de facturaqr.app):\n' +
    ...
    'Planes (MXN/mes, sin costo de instalación ni contratos forzosos): Local $499 (1 comercio, hasta 100 facturas/mes, cartel QR estándar, soporte por correo 72h) · Comercio $999 — el más popular (hasta 3 sucursales, hasta 500 facturas/mes, marca propia en portal/cartel/correos, descarga masiva CSV/ZIP, soporte prioritario WhatsApp 24h, reportes mensuales) · Cadena $2,999 (comercios y facturas ilimitados, soporte dedicado el mismo día, onboarding y alta de CSD asistidos, panel multi-marca). PRUEBA GRATIS: 10 facturas al registrarse, sin tarjeta y sin compromiso. Hay planes a la medida.\n' +
